...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="app/assets/img/banner/banner8.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h2>Clínica escola</h2>
        <h3 class="font-italic bg-success">Odontologista</h3>
      </div>
    </div>
...
<div class="card col mr-5" style="width: 18rem;">
  ...
  <div class="card-body">
    <h5 class="card-title">Odontologista</h5>
